...
#define INSTR_LIST(X) \
    ...
    X(0x03, MN_RR,   AM_NONE, AM_NONE, 1, "RR A") \
    ...
    X(0x13, MN_RRC,  AM_NONE, AM_NONE, 1, "RRC A") \
    ...
    X(0x23, MN_RL,   AM_NONE, AM_NONE, 1, "RL A") \
    ...
    X(0x33, MN_RLC,  AM_NONE, AM_NONE, 1, "RLC A") \
    ...
    X(0xA5, MN_INVALID, AM_NONE, AM_NONE, 1, "UNDEFINED") \
    ...
    X(0xC4, MN_SWAP, AM_NONE, AM_NONE, 1, "SWAP A") \
